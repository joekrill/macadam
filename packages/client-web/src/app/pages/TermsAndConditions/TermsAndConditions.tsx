import { ContainerProps, Link } from "@chakra-ui/react";
...
export interface TermsAndConditionsProps extends ContainerProps {}

/**
 * Generated using TermsFeed
 * @see {@link https://app.termsfeed.com/download/c6fd0934-922e-43a1-97e3-5f53e4ba0625}
 * @see {@link https://www.termsfeed.com/live/c6fd0934-922e-43a1-97e3-5f53e4ba0625}
 *
 * TODO: Localize Terms & Conditions content
 */
  ...
  return (
    <PolicyContainer>
      <Helmet>
        <title>
          {formatMessage({
            id: "termsAndConditions.pages.title",
            description: "The page title for the Terms and Conditions page.",
      ...
      <h1>
        <FormattedMessage
          id="termsAndConditions.page.heading"
          description="The text to show as the heading of the Terms and Conditions page."
          defaultMessage="Terms and Conditions"
        />
      </h1>
