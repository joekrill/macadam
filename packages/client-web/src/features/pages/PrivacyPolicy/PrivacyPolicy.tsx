...
export const PrivacyPolicy = () => (
  <Box p={3}>
    ...
    <Text>
      ...
      same meaning regardless of whether they appear in singUnorderedListar or
      in plural.
    </Text>
    <Heading as="h2" fontSize="xl">
      Definitions
    ...
    <UnorderedList>
      ...
      <ListItem>
        ...
        example, recording the popUnorderedListarity of a certain section and
    ...
    <UnorderedList>
      <ListItem>
        ...
        <Text>
          ...
          fraudUnorderedListent use of user accounts. Without these Cookies, the
    ...
    <UnorderedList>
      <ListItem>
        <Text>By email: privacy@example.com</Text>
      </ListItem>
      <ListItem>
        <Text>
